const kishimotoV1 = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "newMarketingDivisor",
        type: "uint256",
      },
    ],
    name: "updateFeeDivisor",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export const abis = {
  onkishimotoV1: kishimotoV1,
  onKishimotoV2: KishimotoV2,
  onkisimotov1BSC: kisimotov1BSC,
  onkisimotov2BSC: kisimotov2BSC,
  onkatsumi: katsumi,
  onmigrateContract: migrateContract,
  onmigratebnb: migratebnb,
